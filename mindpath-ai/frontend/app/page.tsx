...
function ChatContent() {
  ...
  function openMiniApp(appId: string, id: number) {
    setNavigationStatus("Opening the selected mini-app automatically...");
    saveCurrentSession(id);
    router.push(`/apps/${appId}?session=${id}`);
  }
  ...
  async function sendMessage(event: FormEvent) {
    ...
    try {
      ...
      if (response.suggested_app) {
        openMiniApp(response.suggested_app, sessionId);
      }
    } catch (err) {
  ...
  async function runRouter() {
    ...
    try {
      ...
      openMiniApp(response.recommended_app, sessionId);
    } catch (err) {
  ...
  return (
    <div className="container grid">
      <section className="card">
        ...
        <p>Write a short message. MindPath will recommend and open the best mini-app automatically.</p>
      </section>
      ...
      <div className="grid grid-2">
        <section className="panel grid">
          ...
          <form className="form" onSubmit={sendMessage}>
            ...
            {navigationStatus && <p className="success">{navigationStatus}</p>}
            <div className="actions">
        ...
        <aside className="grid">
          <section className="panel">
            ...
            {context ? (
              ...
              <p>Context appears after building context or routing.</p>
            )}
          </section>
          ...
          <section className="panel">
            ...
            {route ? (
              ...
              <p>Router will open the recommended mini-app automatically.</p>
            )}
          </section>
        </aside>
      </div>
